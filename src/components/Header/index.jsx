...
function index() {
  ...
  return (
    <>
      <nav className="w-screen h-16 bg-[#FAFAFA] max-md:justify-between relative px-6 flex justify-between font-medium text-base items-center font-lalezar antialiased">
          ...
          <div className="float-right flex items-center gap-6 text-nowrap">
              ...
              <button className='max-md:hidden text-nowrap px-6 text-[#CC0E0E] hover:text-[#CC0E0E] border-2 border-[#CC0E0E] hover:border-[#832c2c] rounded-sm py-1 transition-colors duration-500' type="button">Satış Yap</button> 
              {
                isLoggedIn ? 
                <div className="relative gap-5 flex flex-col">
                  ...
                  <Popover className={`${clickedUserModal ? 'visible opacity-100' : 'invisible opacity-0'} z-10  drop-shadow-md flex flex-col items-center transition-all duration-300 ease-out absolute w-[219px] h-[261px] bg-[#FFFFFF] top-14 right-0 border border-[#CCCCCC] text-black`}>
