...
function index() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-hero-pattern bg-cover bg-center flex items-center">
      <div className="px-4 md:px-7 h-auto  max-sm:text-center max-lg:max-w-2xl max-sm:mx-auto max-sm:max-w-md  max-w-3xl xs:max-w-lg py-10 bg-[#F0EDEE]/90 flex flex-col gap-4 ml-4 md:ml-24 rounded-xl drop-shadow-md font-lalezar relative">
